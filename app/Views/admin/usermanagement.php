        ...
        <div class="row mb-3">
            <div class="col-12 col-sm-6">
                <form id="search-form" class="d-flex" role="search">
                    <input class="form-control" id="keyword-input" name="keyword" type="search" placeholder="Search" aria-label="Search">
...
<script src="<?= base_url('js/usermanagement.js') ?>"></script>
